...
*/
        ...
        ObjectList.objects.add(new Circle2(200,160,50,Color.BLACK,true,true));
        Objecto2 o = new Circle2(200,0,50,Color.GREEN,true, false);
        o.bounce = 1f;
        o.gravity = 5f;
        o.drag= 0f;
        o.debug=false;
...
*/
        ...
        Disegno p = new Disegno(ObjectList.objects); //serve una nuova classe disegno per testare Objecto2
